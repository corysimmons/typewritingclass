      ...
      examples: [
        {
          ...
          twcElement: React.createElement('span', { className: cx(textColor('blue-600'), text(lg)) }, 'Blue text'),
        ...
        },
        {
          ...
          twcElement: React.createElement('span', { className: cx(textColor('red-500'), text(lg)) }, 'Red text'),
        ...
        },
        {
          ...
          twcElement: React.createElement('span', { className: cx(textColor('emerald-500'), text(lg)) }, 'Emerald text'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(textAlign('center'), bg('indigo-100'), p(2), rounded()) }, 'Centered text'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(textAlign('right'), bg('indigo-100'), p(2), rounded()) }, 'Right-aligned text'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('span', { className: cx(tracking("wide"), text(lg)) }, 'Wide tracking'),
        ...
        },
        {
          ...
          twcElement: React.createElement('span', { className: cx(tracking("widest"), text(lg)) }, 'Widest tracking'),
        ...
        },
        {
          ...
          twcCode: 'leading(2)',
          twcElement: React.createElement('p', { className: cx(text(sm), leading(2), bg('indigo-100'), p(2), rounded(), w(64)) }, 'This paragraph has loose line-height (2) which gives generous spacing between lines of text.'),
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          twcElement: React.createElement('span', { className: cx(textDecoration('underline'), textDecorationColor('red-500'), text(lg)) }, 'Red underline'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(textOverflow('ellipsis'), overflow('hidden'), whitespace('nowrap'), w(48), bg('indigo-100'), p(2), rounded(), text(sm)) }, 'This is a very long text that should be truncated with an ellipsis'),
        ...
        },
        {
          label: 'line-clamp-2',
          twcCode: 'lineClamp(2)',
          twcElement: React.createElement('div', { className: cx(lineClamp(2), w(64), bg('indigo-100'), p(2), rounded(), text(sm)) }, 'This is a longer text that should be clamped to two lines. Any additional content beyond the second line will be hidden with an ellipsis at the end.'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('ul', { className: cx(listStyleType('disc'), listStylePosition('inside'), bg('indigo-100'), p(3), rounded(), text(sm)) },
        ...
        },
        {
          ...
          twcElement: React.createElement('ol', { className: cx(listStyleType('decimal'), listStylePosition('inside'), bg('indigo-100'), p(3), rounded(), text(sm)) },
            React.createElement('li', { key: 1 }, 'First item'),
            React.createElement('li', { key: 2 }, 'Second item'),
            React.createElement('li', { key: 3 }, 'Third item'),
          ),
