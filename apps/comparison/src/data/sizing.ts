      ...
      examples: [
        {
          label: 'w-32 (8rem)',
          twcCode: 'w(32)',
          twcElement: React.createElement('div', { className: cx(w(32), bg('#818cf8'), p(2), rounded(), textColor('#ffffff'), text(xs)) }, 'w-32'),
          tailwindCode: 'w-32',
        ...
        },
        {
          label: 'w-full (100%)',
          twcCode: 'w("100%")',
          twcElement: React.createElement('div', { className: cx(w('100%'), bg('#818cf8'), p(2), rounded(), textColor('#ffffff'), text(xs)) }, 'w-full'),
          tailwindCode: 'w-full',
        ...
        },
        {
          label: 'w-1/2 (50%)',
          twcCode: 'w("50%")',
          twcElement: React.createElement('div', { className: cx(w('50%'), bg('#818cf8'), p(2), rounded(), textColor('#ffffff'), text(xs)) }, 'w-1/2'),
          tailwindCode: 'w-1/2',
      ...
      examples: [
        {
          label: 'h-16 (4rem)',
          twcCode: 'h(16)',
          twcElement: React.createElement('div', { className: cx(h(16), w(16), bg('#818cf8'), rounded(), flex(), items('center'), justify('center'), textColor('#ffffff'), text(xs)) }, 'h-16'),
          tailwindCode: 'h-16',
      ...
      examples: [
        {
          ...
          twcCode: 'size(12)',
          twcElement: React.createElement('div', { className: cx(size(12), bg('#818cf8'), rounded(), flex(), items('center'), justify('center'), textColor('#ffffff'), text(xs)) }, '12'),
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          label: 'max-h-20 (5rem)',
          twcCode: 'maxH(20)',
          twcElement: React.createElement('div', { className: cx(maxH(20), w(24), bg('#818cf8'), p(2), rounded(), overflow('auto'), textColor('#ffffff'), text(xs)) }, 'Content that is taller than max-h-20 will scroll because of overflow auto applied to this container.'),
