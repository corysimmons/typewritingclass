    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          twcCode: 'cx(bgGradient("to bottom right"), gradientFrom("#f43f5e"), gradientVia("#f59e0b"), gradientTo("#10b981"))',
      ...
      examples: [
        {
          ...
          twcCode: 'cx(bgClip("text"), bgGradient("to right"), gradientFrom("#3b82f6"), gradientTo("#8b5cf6"), textColor("transparent"))',
