      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: tw.cursor('pointer').bg('indigo-200').p(4).rounded.text('xs') }, 'Hover for pointer cursor'),
        ...
        },
        {
          label: 'cursor-wait',
          twcCode: 'cursor("wait")',
          twcElement: React.createElement('div', { className: tw.cursor('wait').bg('indigo-200').p(4).rounded.text('xs') }, 'Hover for wait cursor'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: tw.cursor('not-allowed').bg('indigo-200').p(4).rounded.text('xs') }, 'Hover for not-allowed cursor'),
        ...
        },
        {
          label: 'cursor-grab',
          twcCode: 'cursor("grab")',
          twcElement: React.createElement('div', { className: tw.cursor('grab').bg('indigo-200').p(4).rounded.text('xs') }, 'Hover for grab cursor'),
      ...
      examples: [
        {
          label: 'select-none',
          twcCode: 'select("none")',
          twcElement: React.createElement('div', { className: tw.select('none').bg('indigo-200').p(4).rounded.text('xs') }, 'Try to select this text (select-none)'),
        ...
        },
        {
          label: 'select-all',
          twcCode: 'select("all")',
          twcElement: React.createElement('div', { className: tw.select('all').bg('indigo-200').p(4).rounded.text('xs') }, 'Click to select all text'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: tw.pointerEvents('none').bg('indigo-200').p(4).rounded.opacity(0.5).text('xs') }, 'Cannot interact (pointer-events-none)'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: tw.resize('both').overflow('auto').bg('indigo-200').p(4).rounded.border.borderColor('indigo-400').w(48).h(16).text('xs') }, 'Resize me (both)'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: tw.resize('vertical').overflow('auto').bg('indigo-200').p(4).rounded.border.borderColor('indigo-400').w(48).h(16).text('xs') }, 'Resize vertical'),
      ...
      examples: [
        {
          ...
          twcCode: 'accentColor("indigo-500")',
          twcElement: React.createElement('label', { className: tw.flex.gap(2).items('center').text('xs') },
            React.createElement('input', { type: 'checkbox', className: tw.accentColor('indigo-500'), defaultChecked: true }),
        ...
        {
          label: 'caret-red-500',
          twcCode: 'caretColor("red-500")',
          twcElement: React.createElement('input', { type: 'text', placeholder: 'Type here (red caret)', className: tw.caretColor('red-500').p(2).border.borderColor('slate-200').rounded.w(48).text('xs') }),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: tw.snapType('x mandatory').flex.overflow('auto').gap(2).scrollPaddingL(2).w(56) },
            React.createElement('div', { className: tw.snapAlign('start').bg('indigo-400').p(4).rounded.textColor('white').shrink(0).w(24).text('xs').textAlign('center') }, 'Snap 1'),
            React.createElement('div', { className: tw.snapAlign('start').bg('indigo-400').p(4).rounded.textColor('white').shrink(0).w(24).text('xs').textAlign('center') }, 'Snap 2'),
            React.createElement('div', { className: tw.snapAlign('start').bg('indigo-400').p(4).rounded.textColor('white').shrink(0).w(24).text('xs').textAlign('center') }, 'Snap 3'),
            React.createElement('div', { className: tw.snapAlign('start').bg('indigo-400').p(4).rounded.textColor('white').shrink(0).w(24).text('xs').textAlign('center') }, 'Snap 4'),
            React.createElement('div', { className: tw.snapAlign('start').bg('indigo-400').p(4).rounded.textColor('white').shrink(0).w(24).text('xs').textAlign('center') }, 'Snap 5'),
          ),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('select', { className: tw.appearance('none').p(2).border.borderColor('indigo-400').rounded.bg('white').w(40).text('xs') },
