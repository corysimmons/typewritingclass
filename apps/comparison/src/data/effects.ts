...
import { lg as lgRadius, full as fullRadius } from 'typewritingclass/theme/borders'
      ...
      examples: [
        {
          label: 'shadow-sm',
          twcCode: 'shadow(sm)',
          twcElement: React.createElement('div', { className: cx(shadow(smShadow), bg('#ffffff'), p(4), rounded(lgRadius), text(xs)) }, 'shadow-sm'),
        ...
        },
        {
          label: 'shadow',
          twcCode: 'shadow()',
          twcElement: React.createElement('div', { className: cx(shadow(), bg('#ffffff'), p(4), rounded(lgRadius), text(xs)) }, 'shadow'),
          tailwindCode: 'shadow',
        ...
        },
        {
          label: 'shadow-md',
          twcCode: 'shadow(md)',
          twcElement: React.createElement('div', { className: cx(shadow(mdShadow), bg('#ffffff'), p(4), rounded(lgRadius), text(xs)) }, 'shadow-md'),
        ...
        },
        {
          label: 'shadow-lg',
          twcCode: 'shadow(lg)',
          twcElement: React.createElement('div', { className: cx(shadow(lgShadow), bg('#ffffff'), p(4), rounded(lgRadius), text(xs)) }, 'shadow-lg'),
        ...
        },
        {
          label: 'shadow-xl',
          twcCode: 'shadow(xl)',
          twcElement: React.createElement('div', { className: cx(shadow(xlShadow), bg('#ffffff'), p(4), rounded(lgRadius), text(xs)) }, 'shadow-xl'),
      ...
      examples: [
        {
          label: 'opacity-100',
          twcCode: 'opacity("1")',
          twcElement: React.createElement('div', { className: cx(opacity(1), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'opacity-100'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(opacity(0.75), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'opacity-75'),
        ...
        },
        {
          label: 'opacity-50',
          twcCode: 'opacity("0.5")',
          twcElement: React.createElement('div', { className: cx(opacity(0.5), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'opacity-50'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(opacity(0.25), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'opacity-25'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(flex(), gap(0), bg('#e0e7ff'), p(4), rounded(lgRadius)) },
            React.createElement('div', { className: cx(w('5rem'), h('5rem'), bg('#3b82f6'), rounded(fullRadius), opacity(0.75)) }),
            React.createElement('div', { className: cx(mixBlendMode('multiply'), w('5rem'), h('5rem'), bg('#ef4444'), rounded(fullRadius), ml('-2rem'), opacity(0.75)) }),
          ),
