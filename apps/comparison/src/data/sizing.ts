      ...
      examples: [
        {
          label: 'w-32 (8rem)',
          twcCode: 'w(32)',
          twcElement: React.createElement('div', { className: cx(w(32), bg('indigo-400'), p(2), rounded(), textColor('white'), text(xs)) }, 'w-32'),
          tailwindCode: 'w-32',
        ...
        },
        {
          label: 'w-full (100%)',
          twcCode: 'w("full")',
          twcElement: React.createElement('div', { className: cx(w("full"), bg('indigo-400'), p(2), rounded(), textColor('white'), text(xs)) }, 'w-full'),
          tailwindCode: 'w-full',
        ...
        },
        {
          label: 'w-1/2 (50%)',
          twcCode: 'w("1/2")',
          twcElement: React.createElement('div', { className: cx(w("1/2"), bg('indigo-400'), p(2), rounded(), textColor('white'), text(xs)) }, 'w-1/2'),
          tailwindCode: 'w-1/2',
      ...
      examples: [
        {
          label: 'h-16 (4rem)',
          twcCode: 'h(16)',
          twcElement: React.createElement('div', { className: cx(h(16), w(16), bg('indigo-400'), rounded(), flex(), items('center'), justify('center'), textColor('white'), text(xs)) }, 'h-16'),
          tailwindCode: 'h-16',
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bg('indigo-400'), p(2), rounded(), textColor('white'), text(xs), maxH(12), overflow('hidden')) }, 'h-screen (100vh — capped for display)'),
      ...
      examples: [
        {
          ...
          twcCode: 'size(12)',
          twcElement: React.createElement('div', { className: cx(size(12), bg('indigo-400'), rounded(), flex(), items('center'), justify('center'), textColor('white'), text(xs)) }, '12'),
      ...
      examples: [
        {
          label: 'min-w-[8rem]',
          twcCode: 'minW("8rem")',
          twcElement: React.createElement('div', { className: cx(minW('8rem'), bg('indigo-400'), p(2), rounded(), textColor('white'), text(xs), display('inline-block')) }, 'min-w'),
        ...
        },
        {
          ...
          twcCode: 'maxW("xs")',
          twcElement: React.createElement('div', { className: cx(maxW("xs"), bg('indigo-400'), p(2), rounded(), textColor('white'), text(xs)) }, 'This text is constrained to max-w-xs (20rem) and will wrap when it exceeds that width.'),
        ...
        },
        {
          label: 'min-h-[4rem]',
          twcCode: 'minH("4rem")',
          twcElement: React.createElement('div', { className: cx(minH('4rem'), w(24), bg('indigo-400'), p(2), rounded(), flex(), items('center'), textColor('white'), text(xs)) }, 'min-h'),
        ...
        },
        {
          label: 'max-h-20 (5rem)',
          twcCode: 'maxH(20)',
          twcElement: React.createElement('div', { className: cx(maxH(20), w(24), bg('indigo-400'), p(2), rounded(), overflow('auto'), textColor('white'), text(xs)) }, 'Content that is taller than max-h-20 will scroll because of overflow auto applied to this container.'),
