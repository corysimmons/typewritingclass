      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(flex(), gap(0), bg('#e0e7ff'), p(4), rounded("lg")) },
            React.createElement('div', { className: cx(w(20), h(20), bg('#3b82f6'), rounded("full"), opacity(0.75)) }),
            React.createElement('div', { className: cx(mixBlendMode('multiply'), w(20), h(20), bg('#ef4444'), rounded("full"), ml(-8), opacity(0.75)) }),
          ),
