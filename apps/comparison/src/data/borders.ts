  ...
  sections: [
      ...
      examples: [
        {
          ...
          twcCode: 'rounded()',
          twcElement: React.createElement('div', { className: tw.rounded.bg('indigo-400').p(4).textColor('white').text('xs') }, 'rounded'),
        ...
        },
        {
          ...
          twcCode: 'rounded("lg")',
          twcElement: React.createElement('div', { className: tw.rounded("lg").bg('indigo-400').p(4).textColor('white').text('xs') }, 'rounded-lg'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: tw.rounded("full").bg('indigo-400').w(16).h(16).flex.items('center').justify('center').textColor('white').text('xs') }, 'full'),
        ...
        },
        {
          label: 'rounded-t-lg',
          twcCode: 'roundedT("lg")',
          twcElement: React.createElement('div', { className: tw.roundedT("lg").bg('indigo-400').p(4).textColor('white').text('xs') }, 'rounded-t-lg'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: tw.roundedBL("xl").bg('indigo-400').p(4).textColor('white').text('xs') }, 'rounded-bl-xl'),
    ...
    },
    {
      ...
      examples: [
        {
          label: 'border (1px)',
          twcCode: 'border(), borderColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.border.borderColor('indigo-400').p(4).rounded.text('xs') }, 'border'),
        ...
        {
          label: 'border-2',
          twcCode: 'border(2), borderColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.border(2).borderColor('indigo-400').p(4).rounded.text('xs') }, 'border-2'),
        ...
        {
          label: 'border-t-4',
          twcCode: 'borderT(4), borderColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.borderT(4).borderColor('indigo-400').p(4).bg('slate-50').text('xs') }, 'border-t-4'),
        ...
        {
          label: 'border-x-2',
          twcCode: 'borderX(2), borderColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.borderX(2).borderColor('indigo-400').p(4).text('xs') }, 'border-x-2'),
    ...
    },
    {
      ...
      examples: [
        {
          label: 'border-dashed',
          twcCode: 'border(2), borderStyle("dashed"), borderColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.border(2).borderStyle('dashed').borderColor('indigo-400').p(4).rounded.text('xs') }, 'dashed'),
        ...
        {
          label: 'border-dotted',
          twcCode: 'border(2), borderStyle("dotted"), borderColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.border(2).borderStyle('dotted').borderColor('indigo-400').p(4).rounded.text('xs') }, 'dotted'),
    ...
    },
    {
      ...
      examples: [
        {
          label: 'divide-y',
          twcCode: 'flex(), flexCol(), divideY(), divideColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.flex.flexCol.divideY.divideColor('indigo-400') },
            React.createElement('div', { className: tw.p(3).text('xs') }, 'Item 1'),
            React.createElement('div', { className: tw.p(3).text('xs') }, 'Item 2'),
            React.createElement('div', { className: tw.p(3).text('xs') }, 'Item 3'),
          ),
        ...
        {
          label: 'divide-x-2',
          twcCode: 'flex(), divideX(2), divideColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.flex.divideX(2).divideColor('indigo-400') },
            React.createElement('div', { className: tw.p(3).text('xs') }, 'A'),
            React.createElement('div', { className: tw.p(3).text('xs') }, 'B'),
            React.createElement('div', { className: tw.p(3).text('xs') }, 'C'),
          ),
      ...
      examples: [
        {
          ...
          twcCode: 'ring(2), ringColor("blue-500")',
          twcElement: React.createElement('div', { className: tw.ring(2).ringColor('blue-500').p(4).rounded.text('xs') }, 'ring-2'),
        ...
        },
        {
          ...
          twcCode: 'ring(4), ringColor("indigo-400"), ringOffsetWidth(2), ringOffsetColor("white")',
          twcElement: React.createElement('div', { className: tw.ring(4).ringColor('indigo-400').ringOffsetWidth(2).ringOffsetColor('white').p(4).rounded.bg('slate-50').text('xs') }, 'ring + offset'),
      ...
      examples: [
        {
          ...
          twcCode: 'outlineWidth(2), outlineStyle("dashed"), outlineColor("indigo-400")',
          twcElement: React.createElement('div', { className: tw.outlineWidth(2).outlineStyle('dashed').outlineColor('indigo-400').p(4).rounded.text('xs') }, 'outline dashed'),
        ...
        },
        {
          ...
          twcCode: 'outlineWidth(2), outlineStyle("solid"), outlineColor("indigo-400"), outlineOffset(4)',
          twcElement: React.createElement('div', { className: tw.outlineWidth(2).outlineStyle('solid').outlineColor('indigo-400').outlineOffset(4).p(4).rounded.bg('slate-50').text('xs') }, 'outline + offset'),
