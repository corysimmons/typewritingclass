      ...
      examples: [
        {
          ...
          twcCode: 'rounded()',
          twcElement: React.createElement('div', { className: cx(rounded(), bg('indigo-400'), p(4), textColor('white'), text(xs)) }, 'rounded'),
        ...
        },
        {
          ...
          twcCode: 'rounded("lg")',
          twcElement: React.createElement('div', { className: cx(rounded("lg"), bg('indigo-400'), p(4), textColor('white'), text(xs)) }, 'rounded-lg'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(rounded("full"), bg('indigo-400'), w(16), h(16), flex(), items('center'), justify('center'), textColor('white'), text(xs)) }, 'full'),
        ...
        },
        {
          label: 'rounded-t-lg',
          twcCode: 'roundedT("lg")',
          twcElement: React.createElement('div', { className: cx(roundedT("lg"), bg('indigo-400'), p(4), textColor('white'), text(xs)) }, 'rounded-t-lg'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(roundedBL("xl"), bg('indigo-400'), p(4), textColor('white'), text(xs)) }, 'rounded-bl-xl'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(border(), borderColor('indigo-400'), p(4), rounded(), text(xs)) }, 'border'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(border(2), borderColor('indigo-400'), p(4), rounded(), text(xs)) }, 'border-2'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(borderT(4), borderColor('indigo-400'), p(4), bg('slate-50'), text(xs)) }, 'border-t-4'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(borderX(2), borderColor('indigo-400'), p(4), text(xs)) }, 'border-x-2'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(border(2), borderStyle('dashed'), borderColor('indigo-400'), p(4), rounded(), text(xs)) }, 'dashed'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(border(2), borderStyle('dotted'), borderColor('indigo-400'), p(4), rounded(), text(xs)) }, 'dotted'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(flex(), flexCol(), divideY(), divideColor('indigo-400')) },
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(flex(), divideX(2), divideColor('indigo-400')) },
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(ring(2), ringColor('blue-500'), p(4), rounded(), text(xs)) }, 'ring-2'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(ring(4), ringColor('indigo-400'), ringOffsetWidth(2), ringOffsetColor('white'), p(4), rounded(), bg('slate-50'), text(xs)) }, 'ring + offset'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(outlineWidth(2), outlineStyle('dashed'), outlineColor('indigo-400'), p(4), rounded(), text(xs)) }, 'outline dashed'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(outlineWidth(2), outlineStyle('solid'), outlineColor('indigo-400'), outlineOffset(4), p(4), rounded(), bg('slate-50'), text(xs)) }, 'outline + offset'),
