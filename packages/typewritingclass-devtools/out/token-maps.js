...
exports.ARG_UTILITIES = exports.VALUELESS_UTILITIES = exports.MODIFIER_NAMES = exports.TOKEN_AWARE_UTILITIES = exports.RADIUS_UTILITIES = exports.COLOR_UTILITIES = exports.UTIL_TOKENS = exports.gradientDirectionTokens = exports.textTransformTokens = exports.textOverflowTokens = exports.textWrapTokens = exports.selfTokens = exports.objectFitTokens = exports.textAlignTokens = exports.cursorTokens = exports.overflowTokens = exports.displayTokens = exports.justifyTokens = exports.alignItemsTokens = exports.fontFamilyTokens = exports.leadingTokens = exports.trackingTokens = exports.fontWeightTokens = exports.textSizeTokens = exports.shadowTokens = exports.radiusTokens = exports.colorTokens = void 0;
exports.isTokenAwareUtility = isTokenAwareUtility;
exports.isTokenForUtility = isTokenForUtility;
exports.resolveTokenArg = resolveTokenArg;
exports.isColorUtility = isColorUtility;
exports.resolveColorTokenToHex = resolveColorTokenToHex;
// ---------------------------------------------------------------------------
...
for (const name of colorScaleNames) {
    for (const shade of shades) {
        exports.colorTokens[`${name}${shade}`] = `${name}-${shade}`;
    }
}
exports.colorTokens['white'] = 'white';
exports.colorTokens['black'] = 'black';
exports.colorTokens['transparent'] = 'transparent';
exports.colorTokens['current'] = 'current';
// ---------------------------------------------------------------------------
// Radius tokens
// ---------------------------------------------------------------------------
...
// Layout enum tokens
// ---------------------------------------------------------------------------
exports.alignItemsTokens = {
    center: 'center', start: 'flex-start', end: 'flex-end',
    baseline: 'baseline', stretch: 'stretch',
};
exports.justifyTokens = {
    center: 'center', start: 'flex-start', end: 'flex-end',
    between: 'space-between', around: 'space-around', evenly: 'space-evenly',
    stretch: 'stretch',
};
exports.displayTokens = {
...
exports.textAlignTokens = {
    left: 'left', center: 'center', right: 'right',
    justify: 'justify', start: 'start', end: 'end',
};
exports.objectFitTokens = {
...
exports.UTIL_TOKENS = {
    // Color utilities
    bg: { tokens: exports.colorTokens, supportsOpacity: true },
    textColor: { tokens: exports.colorTokens, supportsOpacity: true },
    borderColor: { tokens: exports.colorTokens, supportsOpacity: true },
    shadowColor: { tokens: exports.colorTokens, supportsOpacity: true },
    ringColor: { tokens: exports.colorTokens, supportsOpacity: true },
    outlineColor: { tokens: exports.colorTokens, supportsOpacity: true },
    accentColor: { tokens: exports.colorTokens, supportsOpacity: true },
    caretColor: { tokens: exports.colorTokens, supportsOpacity: true },
    divideColor: { tokens: exports.colorTokens, supportsOpacity: true },
    textDecorationColor: { tokens: exports.colorTokens, supportsOpacity: true },
    gradientFrom: { tokens: exports.colorTokens },
    gradientVia: { tokens: exports.colorTokens },
    gradientTo: { tokens: exports.colorTokens },
    // Radius utilities
    rounded: { tokens: exports.radiusTokens },
    roundedT: { tokens: exports.radiusTokens },
    roundedB: { tokens: exports.radiusTokens },
    roundedL: { tokens: exports.radiusTokens },
    roundedR: { tokens: exports.radiusTokens },
    roundedTL: { tokens: exports.radiusTokens },
    roundedTR: { tokens: exports.radiusTokens },
    roundedBR: { tokens: exports.radiusTokens },
    roundedBL: { tokens: exports.radiusTokens },
    roundedSS: { tokens: exports.radiusTokens },
    roundedSE: { tokens: exports.radiusTokens },
    roundedEE: { tokens: exports.radiusTokens },
    roundedES: { tokens: exports.radiusTokens },
    // Shadow
    shadow: { tokens: exports.shadowTokens },
    // Typography
    text: { tokens: exports.textSizeTokens },
    font: { tokens: exports.fontWeightTokens },
    tracking: { tokens: exports.trackingTokens },
    leading: { tokens: exports.leadingTokens },
    fontFamily: { tokens: exports.fontFamilyTokens },
    // Layout enums
    items: { tokens: exports.alignItemsTokens },
    justify: { tokens: exports.justifyTokens },
    display: { tokens: exports.displayTokens },
    overflow: { tokens: exports.overflowTokens },
    overflowX: { tokens: exports.overflowTokens },
    overflowY: { tokens: exports.overflowTokens },
    cursor: { tokens: exports.cursorTokens },
    textAlign: { tokens: exports.textAlignTokens },
    objectFit: { tokens: exports.objectFitTokens },
    self: { tokens: exports.selfTokens },
    textWrap: { tokens: exports.textWrapTokens },
    textOverflow: { tokens: exports.textOverflowTokens },
    textTransform: { tokens: exports.textTransformTokens },
    bgGradient: { tokens: exports.gradientDirectionTokens },
};
// ---------------------------------------------------------------------------
// Utility category sets
// ---------------------------------------------------------------------------
exports.COLOR_UTILITIES = new Set([
...
exports.RADIUS_UTILITIES = new Set([
...
exports.TOKEN_AWARE_UTILITIES = new Set(Object.keys(exports.UTIL_TOKENS));
// ---------------------------------------------------------------------------
// Modifier set (mirrors MODS from tw.ts)
// ---------------------------------------------------------------------------
exports.MODIFIER_NAMES = new Set([
    // Pseudo-classes
...
// ---------------------------------------------------------------------------
exports.VALUELESS_UTILITIES = new Set([
    // Layout
...
function isTokenAwareUtility(name) {
    return exports.TOKEN_AWARE_UTILITIES.has(name);
}
/** Check whether `tokenName` is a valid token for `utilityName`. */
function isTokenForUtility(utilityName, tokenName) {
    const config = exports.UTIL_TOKENS[utilityName];
    if (!config)
        return false;
    return tokenName in config.tokens;
}
/** Resolve a token to its argument string for a given utility. */
function resolveTokenArg(utilityName, tokenName) {
    const config = exports.UTIL_TOKENS[utilityName];
    if (!config)
        return undefined;
...
function isColorUtility(name) {
    return exports.COLOR_UTILITIES.has(name);
}
// ---------------------------------------------------------------------------
 ...
 */
function resolveColorTokenToHex(tokenName) {
    // Look up in colorTokens to get the dash-separated form
    const dashForm = exports.colorTokens[tokenName];
    if (!dashForm)
        return undefined;
    // Named colors
    if (namedColorHex[dashForm])
        return namedColorHex[dashForm];
...
//# sourceMappingURL=token-maps.js.map