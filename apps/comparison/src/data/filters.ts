      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { style: { position: 'relative', width: '12rem', height: '5rem', background: 'linear-gradient(135deg, #818cf8, #f43f5e)', borderRadius: '0.5rem', overflow: 'hidden' } },
            React.createElement('div', { className: cx(backdropBlur('12px'), css({ position: 'absolute', inset: '1rem', borderRadius: '0.25rem', display: 'flex', alignItems: 'center', justifyContent: 'center' })), style: { background: 'rgba(255,255,255,0.2)', color: 'white', fontSize: '12px' } }, 'backdrop-blur'),
          ),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { style: { position: 'relative', width: '12rem', height: '5rem', background: 'linear-gradient(135deg, #818cf8, #f43f5e)', borderRadius: '0.5rem', overflow: 'hidden' } },
            React.createElement('div', { className: cx(backdropGrayscale('100%'), css({ position: 'absolute', inset: '1rem', borderRadius: '0.25rem', display: 'flex', alignItems: 'center', justifyContent: 'center' })), style: { background: 'rgba(255,255,255,0.1)', color: 'white', fontSize: '12px' } }, 'backdrop-grayscale'),
          ),
