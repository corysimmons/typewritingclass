  ...
  sections: [
      ...
      examples: [
        {
          ...
          twcCode: 'transition(), duration(300), when(hover)(bg("indigo-500"))',
          twcElement: React.createElement('div', { className: cx(transition(), duration(300), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), cursor('pointer'), text(xs), when(hover)(bg('indigo-500'))) }, 'Hover me'),
        ...
        },
        {
          ...
          twcCode: 'transitionAll(), duration(500), when(hover)(bg("indigo-500"), scale(105))',
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(500), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), cursor('pointer'), text(xs), when(hover)(bg('indigo-500'), scale(105))) }, 'Hover me'),
        ...
        },
        {
          ...
          twcCode: 'transitionColors(), duration(200), when(hover)(bg("indigo-500"))',
          twcElement: React.createElement('div', { className: cx(transitionColors(), duration(200), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), cursor('pointer'), text(xs), when(hover)(bg('indigo-500'))) }, 'Hover me'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionOpacity(), duration(300), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), cursor('pointer'), text(xs), when(hover)(opacity(0.5))) }, 'Hover me'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionTransform(), duration(300), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), cursor('pointer'), text(xs), when(hover)(scale(110))) }, 'Hover me'),
    ...
    },
    {
      ...
      examples: [
        {
          label: 'duration-75',
          twcCode: 'transitionAll(), duration(75), when(hover)(bg("indigo-400"))',
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(75), bg('indigo-200'), p(3), rounded(), cursor('pointer'), text(xs), when(hover)(bg('indigo-400'))) }, '75ms'),
        ...
        {
          label: 'duration-300',
          twcCode: 'transitionAll(), duration(300), when(hover)(bg("indigo-400"))',
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(300), bg('indigo-200'), p(3), rounded(), cursor('pointer'), text(xs), when(hover)(bg('indigo-400'))) }, '300ms'),
        ...
        {
          label: 'duration-1000',
          twcCode: 'transitionAll(), duration(1000), when(hover)(bg("indigo-400"))',
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(1000), bg('indigo-200'), p(3), rounded(), cursor('pointer'), text(xs), when(hover)(bg('indigo-400'))) }, '1000ms'),
    ...
    },
    {
      ...
      examples: [
        {
          label: 'ease-in',
          twcCode: 'transitionAll(), duration(300), ease("ease-in"), when(hover)(bg("indigo-400"))',
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(300), ease('ease-in'), bg('indigo-200'), p(3), rounded(), cursor('pointer'), text(xs), when(hover)(bg('indigo-400'))) }, 'ease-in'),
        ...
        {
          label: 'ease-out',
          twcCode: 'transitionAll(), duration(300), ease("ease-out"), when(hover)(bg("indigo-400"))',
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(300), ease('ease-out'), bg('indigo-200'), p(3), rounded(), cursor('pointer'), text(xs), when(hover)(bg('indigo-400'))) }, 'ease-out'),
        ...
        {
          label: 'ease-in-out',
          twcCode: 'transitionAll(), duration(300), ease("ease-in-out"), when(hover)(bg("indigo-400"))',
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(300), ease('ease-in-out'), bg('indigo-200'), p(3), rounded(), cursor('pointer'), text(xs), when(hover)(bg('indigo-400'))) }, 'ease-in-out'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(animate("spin"), w(8), h(8), bg('indigo-400'), rounded()) }),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(animate("ping"), w(8), h(8), bg('indigo-400'), rounded("full")) }),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(animate("pulse"), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'pulse'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(animate("bounce"), w(8), h(8), bg('indigo-400'), rounded("full")) }),
