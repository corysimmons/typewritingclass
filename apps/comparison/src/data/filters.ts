      ...
      examples: [
        {
          label: 'blur-none',
          twcCode: 'blur("0")',
          twcElement: React.createElement('div', { className: cx(blur('0'), bg('#818cf8'), p(4), rounded("lg"), w('8rem'), h('3rem'), sampleBoxClasses) }, 'blur-none'),
        ...
        },
        {
          label: 'blur-sm (4px)',
          twcCode: 'blur("4px")',
          twcElement: React.createElement('div', { className: cx(blur('4px'), bg('#818cf8'), p(4), rounded("lg"), w('8rem'), h('3rem'), sampleBoxClasses) }, 'blur-sm'),
        ...
        },
        {
          label: 'blur (8px)',
          twcCode: 'blur("8px")',
          twcElement: React.createElement('div', { className: cx(blur('8px'), bg('#818cf8'), p(4), rounded("lg"), w('8rem'), h('3rem'), sampleBoxClasses) }, 'blur'),
          tailwindCode: 'blur',
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(relative(), w('12rem'), h('5rem'), bgImage('linear-gradient(135deg, #818cf8, #f43f5e)'), rounded("lg"), overflow('hidden')) },
            React.createElement('div', { className: cx(backdropBlur('12px'), absolute(), inset('1rem'), rounded(), flex(), items('center'), justify('center'), bg('rgba(255,255,255,0.2)'), textColor('#ffffff'), text(xs)) }, 'backdrop-blur'),
          ),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(relative(), w('12rem'), h('5rem'), bgImage('linear-gradient(135deg, #818cf8, #f43f5e)'), rounded("lg"), overflow('hidden')) },
            React.createElement('div', { className: cx(backdropGrayscale('100%'), absolute(), inset('1rem'), rounded(), flex(), items('center'), justify('center'), bg('rgba(255,255,255,0.1)'), textColor('#ffffff'), text(xs)) }, 'backdrop-grayscale'),
          ),
