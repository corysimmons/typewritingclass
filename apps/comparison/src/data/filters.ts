...
import { DEFAULT as defaultRadius, lg as lgRadius } from 'typewritingclass/theme/borders'
      ...
      examples: [
        {
          label: 'blur-none',
          twcCode: 'blur("0")',
          twcElement: React.createElement('div', { className: cx(blur('0'), bg('#818cf8'), p(4), rounded(lgRadius), w('8rem'), h('3rem'), sampleBoxClasses) }, 'blur-none'),
        ...
        },
        {
          label: 'blur-sm (4px)',
          twcCode: 'blur("4px")',
          twcElement: React.createElement('div', { className: cx(blur('4px'), bg('#818cf8'), p(4), rounded(lgRadius), w('8rem'), h('3rem'), sampleBoxClasses) }, 'blur-sm'),
        ...
        },
        {
          label: 'blur (8px)',
          twcCode: 'blur("8px")',
          twcElement: React.createElement('div', { className: cx(blur('8px'), bg('#818cf8'), p(4), rounded(lgRadius), w('8rem'), h('3rem'), sampleBoxClasses) }, 'blur'),
          tailwindCode: 'blur',
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(brightness('50%'), bg('#818cf8'), p(4), rounded(lgRadius), sampleBoxClasses) }, 'brightness-50'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(brightness('150%'), bg('#818cf8'), p(4), rounded(lgRadius), sampleBoxClasses) }, 'brightness-150'),
      ...
      examples: [
        {
          label: 'contrast-50',
          twcCode: 'contrast("50%")',
          twcElement: React.createElement('div', { className: cx(contrast('50%'), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'contrast-50'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(contrast('200%'), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'contrast-200'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(grayscale('100%'), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'grayscale'),
        ...
        },
        {
          label: 'sepia',
          twcCode: 'sepia("100%")',
          twcElement: React.createElement('div', { className: cx(sepia('100%'), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'sepia'),
          tailwindCode: 'sepia',
      ...
      examples: [
        {
          label: 'invert',
          twcCode: 'invert("100%")',
          twcElement: React.createElement('div', { className: cx(invert('100%'), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'invert'),
          tailwindCode: 'invert',
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(saturate('200%'), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'saturate-200'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(hueRotate('90deg'), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'hue-rotate-90'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(hueRotate('180deg'), bg('#818cf8'), p(4), rounded(lgRadius), textColor('#ffffff'), text(xs)) }, 'hue-rotate-180'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(relative(), w('12rem'), h('5rem'), bgImage('linear-gradient(135deg, #818cf8, #f43f5e)'), rounded(lgRadius), overflow('hidden')) },
            React.createElement('div', { className: cx(backdropBlur('12px'), absolute(), inset('1rem'), rounded(defaultRadius), flex(), items('center'), justify('center'), bg('rgba(255,255,255,0.2)'), textColor('#ffffff'), text(xs)) }, 'backdrop-blur'),
          ),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(relative(), w('12rem'), h('5rem'), bgImage('linear-gradient(135deg, #818cf8, #f43f5e)'), rounded(lgRadius), overflow('hidden')) },
            React.createElement('div', { className: cx(backdropGrayscale('100%'), absolute(), inset('1rem'), rounded(defaultRadius), flex(), items('center'), justify('center'), bg('rgba(255,255,255,0.1)'), textColor('#ffffff'), text(xs)) }, 'backdrop-grayscale'),
          ),
