...
import {
  ...
  bg, p, w, h, flex, flexCol, textColor, css,
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(rounded('0.25rem'), bg('#818cf8'), p(4), textColor('#ffffff')), style: { fontSize: '12px' } }, 'rounded'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(rounded('0.5rem'), bg('#818cf8'), p(4), textColor('#ffffff')), style: { fontSize: '12px' } }, 'rounded-lg'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(roundedT('0.5rem'), bg('#818cf8'), p(4), textColor('#ffffff')), style: { fontSize: '12px' } }, 'rounded-t-lg'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(roundedBL('0.75rem'), bg('#818cf8'), p(4), textColor('#ffffff')), style: { fontSize: '12px' } }, 'rounded-bl-xl'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(border('1px'), borderColor('#818cf8'), p(4), rounded('4px')), style: { fontSize: '12px' } }, 'border'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(border('2px'), borderColor('#818cf8'), p(4), rounded('4px')), style: { fontSize: '12px' } }, 'border-2'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(borderT('4px'), borderColor('#818cf8'), p(4), bg('#f8fafc')), style: { fontSize: '12px' } }, 'border-t-4'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(borderX('2px'), borderColor('#818cf8'), p(4)), style: { fontSize: '12px' } }, 'border-x-2'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(border('2px'), borderStyle('dashed'), borderColor('#818cf8'), p(4), rounded('4px')), style: { fontSize: '12px' } }, 'dashed'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(border('2px'), borderStyle('dotted'), borderColor('#818cf8'), p(4), rounded('4px')), style: { fontSize: '12px' } }, 'dotted'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(flexCol(), divideY('1px'), divideColor('#818cf8')) },
            React.createElement('div', { className: cx(p(3)), style: { fontSize: '12px' } }, 'Item 1'),
            React.createElement('div', { className: cx(p(3)), style: { fontSize: '12px' } }, 'Item 2'),
            React.createElement('div', { className: cx(p(3)), style: { fontSize: '12px' } }, 'Item 3'),
          ),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(flex(), divideX('2px'), divideColor('#818cf8')) },
            React.createElement('div', { className: cx(p(3)), style: { fontSize: '12px' } }, 'A'),
            React.createElement('div', { className: cx(p(3)), style: { fontSize: '12px' } }, 'B'),
            React.createElement('div', { className: cx(p(3)), style: { fontSize: '12px' } }, 'C'),
          ),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(ring('2px'), ringColor('#3b82f6'), p(4), rounded('4px')), style: { fontSize: '12px' } }, 'ring-2'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(ring('4px'), ringColor('#818cf8'), ringOffsetWidth('2px'), ringOffsetColor('#ffffff'), p(4), rounded('4px'), bg('#f8fafc')), style: { fontSize: '12px' } }, 'ring + offset'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(outlineWidth('2px'), outlineStyle('dashed'), outlineColor('#818cf8'), p(4), rounded('4px')), style: { fontSize: '12px' } }, 'outline dashed'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(outlineWidth('2px'), outlineStyle('solid'), outlineColor('#818cf8'), outlineOffset('4px'), p(4), rounded('4px'), bg('#f8fafc')), style: { fontSize: '12px' } }, 'outline + offset'),
