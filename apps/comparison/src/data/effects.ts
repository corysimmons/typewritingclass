      ...
      examples: [
        {
          label: 'shadow-sm',
          twcCode: 'shadow("sm")',
          twcElement: React.createElement('div', { className: cx(shadow("sm"), bg('white'), p(4), rounded("lg"), text(xs)) }, 'shadow-sm'),
        ...
        },
        {
          label: 'shadow',
          twcCode: 'shadow()',
          twcElement: React.createElement('div', { className: cx(shadow(), bg('white'), p(4), rounded("lg"), text(xs)) }, 'shadow'),
          tailwindCode: 'shadow',
        ...
        },
        {
          label: 'shadow-md',
          twcCode: 'shadow("md")',
          twcElement: React.createElement('div', { className: cx(shadow("md"), bg('white'), p(4), rounded("lg"), text(xs)) }, 'shadow-md'),
        ...
        },
        {
          label: 'shadow-lg',
          twcCode: 'shadow("lg")',
          twcElement: React.createElement('div', { className: cx(shadow("lg"), bg('white'), p(4), rounded("lg"), text(xs)) }, 'shadow-lg'),
        ...
        },
        {
          label: 'shadow-xl',
          twcCode: 'shadow("xl")',
          twcElement: React.createElement('div', { className: cx(shadow("xl"), bg('white'), p(4), rounded("lg"), text(xs)) }, 'shadow-xl'),
      ...
      examples: [
        {
          label: 'opacity-100',
          twcCode: 'opacity(1)',
          twcElement: React.createElement('div', { className: cx(opacity(1), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'opacity-100'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(opacity(0.75), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'opacity-75'),
        ...
        },
        {
          label: 'opacity-50',
          twcCode: 'opacity(0.5)',
          twcElement: React.createElement('div', { className: cx(opacity(0.5), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'opacity-50'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(opacity(0.25), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'opacity-25'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(flex(), gap(0), bg('indigo-100'), p(4), rounded("lg")) },
            React.createElement('div', { className: cx(w(20), h(20), bg('blue-500'), rounded("full"), opacity(0.75)) }),
            React.createElement('div', { className: cx(mixBlendMode('multiply'), w(20), h(20), bg('red-500'), rounded("full"), ml(-8), opacity(0.75)) }),
          ),
