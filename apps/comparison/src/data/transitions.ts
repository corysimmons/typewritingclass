      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(transition(), duration(300), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff'), cursor('pointer'), text(xs), when(hover)(bg('#6366f1'))) }, 'Hover me'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(500), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff'), cursor('pointer'), text(xs), when(hover)(bg('#6366f1'), scale(105))) }, 'Hover me'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionColors(), duration(200), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff'), cursor('pointer'), text(xs), when(hover)(bg('#6366f1'))) }, 'Hover me'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionOpacity(), duration(300), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff'), cursor('pointer'), text(xs), when(hover)(opacity(0.5))) }, 'Hover me'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionTransform(), duration(300), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff'), cursor('pointer'), text(xs), when(hover)(scale(110))) }, 'Hover me'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(75), bg('#c7d2fe'), p(3), rounded('0.25rem'), cursor('pointer'), text(xs), when(hover)(bg('#818cf8'))) }, '75ms'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(300), bg('#c7d2fe'), p(3), rounded('0.25rem'), cursor('pointer'), text(xs), when(hover)(bg('#818cf8'))) }, '300ms'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(1000), bg('#c7d2fe'), p(3), rounded('0.25rem'), cursor('pointer'), text(xs), when(hover)(bg('#818cf8'))) }, '1000ms'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(300), ease('ease-in'), bg('#c7d2fe'), p(3), rounded('0.25rem'), cursor('pointer'), text(xs), when(hover)(bg('#818cf8'))) }, 'ease-in'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(300), ease('ease-out'), bg('#c7d2fe'), p(3), rounded('0.25rem'), cursor('pointer'), text(xs), when(hover)(bg('#818cf8'))) }, 'ease-out'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(transitionAll(), duration(300), ease('ease-in-out'), bg('#c7d2fe'), p(3), rounded('0.25rem'), cursor('pointer'), text(xs), when(hover)(bg('#818cf8'))) }, 'ease-in-out'),
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(animate('ping 1s cubic-bezier(0,0,0.2,1) infinite'), w('2rem'), h('2rem'), bg('#818cf8'), rounded('9999px')) }),
