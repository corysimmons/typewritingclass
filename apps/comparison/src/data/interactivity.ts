      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: `${tw.snapType('x mandatory').flex.overflow('auto').gap(2).scrollPaddingL(2).w(56)}` },
            ...[1,2,3,4,5].map(n => React.createElement('div', { key: n, className: `${tw.snapAlign('start').bg('indigo-400').p(4).rounded.textColor('white').shrink(0).w(24).text(xs).textAlign('center')}` }, `Snap ${n}`)),
          ),
