      ...
      examples: [
        {
          label: 'bg-blue-500',
          twcCode: 'bg("#3b82f6")',
          twcElement: React.createElement('div', { className: cx(bg('#3b82f6'), p(4), rounded(), textColor('#ffffff')) }, 'bg-blue-500'),
        ...
        },
        {
          ...
          twcCode: 'bg("#34d399")',
          twcElement: React.createElement('div', { className: cx(bg('#34d399'), p(4), rounded(), textColor('#ffffff')) }, 'bg-emerald-400'),
        ...
        },
        {
          label: 'bg-rose-500',
          twcCode: 'bg("#f43f5e")',
          twcElement: React.createElement('div', { className: cx(bg('#f43f5e'), p(4), rounded(), textColor('#ffffff')) }, 'bg-rose-500'),
        ...
        },
        {
          label: 'bg-amber-300',
          twcCode: 'bg("#fcd34d")',
          twcElement: React.createElement('div', { className: cx(bg('#fcd34d'), p(4), rounded()) }, 'bg-amber-300'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgGradient('to right'), gradientFrom('#3b82f6'), gradientTo('#8b5cf6'), p(4), rounded(), textColor('#ffffff')) }, 'to right'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgGradient('to bottom right'), gradientFrom('#f43f5e'), gradientVia('#f59e0b'), gradientTo('#10b981'), p(4), rounded(), textColor('#ffffff')) }, 'to bottom right'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgGradient('to top'), gradientFrom('#10b981'), gradientTo('#06b6d4'), p(4), rounded(), textColor('#ffffff')) }, 'to top'),
      ...
      examples: [
        {
          ...
          twcCode: 'bgClip("text"), bgGradient("to right"), gradientFrom("#3b82f6"), gradientTo("#8b5cf6"), textColor("transparent")',
          twcElement: React.createElement('span', { className: cx(bgClip('text'), text(_2xl), font(bold), bgGradient('to right'), gradientFrom('#3b82f6'), gradientTo('#8b5cf6'), textColor('transparent')) }, 'Gradient Text'),
