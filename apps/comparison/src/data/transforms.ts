      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { style: { padding: '2rem', display: 'flex', justifyContent: 'center' } },
            React.createElement('div', { className: cx(rotate('45deg'), bg('#818cf8'), w('3rem'), h('3rem'), rounded('0.25rem'), flex(), css({ alignItems: 'center', justifyContent: 'center' }), textColor('#ffffff')), style: { fontSize: '12px' } }, '45'),
          ),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { style: { padding: '2rem', display: 'flex', justifyContent: 'center' } },
            React.createElement('div', { className: cx(rotate('90deg'), bg('#818cf8'), w('3rem'), h('3rem'), rounded('0.25rem'), flex(), css({ alignItems: 'center', justifyContent: 'center' }), textColor('#ffffff')), style: { fontSize: '12px' } }, '90'),
          ),
