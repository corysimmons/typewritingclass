      ...
      examples: [
        {
          label: 'w-32 (8rem)',
          twcCode: 'cx(w(32))',
          twcElement: React.createElement('div', { className: cx(w(32), bg('#818cf8'), p(2), rounded('4px'), textColor('#ffffff'), text(xs)) }, 'w-32'),
          tailwindCode: 'w-32',
        ...
        },
        {
          label: 'w-full (100%)',
          twcCode: 'cx(w("100%"))',
          twcElement: React.createElement('div', { className: cx(w('100%'), bg('#818cf8'), p(2), rounded('4px'), textColor('#ffffff'), text(xs)) }, 'w-full'),
          tailwindCode: 'w-full',
        ...
        },
        {
          label: 'w-1/2 (50%)',
          twcCode: 'cx(w("50%"))',
          twcElement: React.createElement('div', { className: cx(w('50%'), bg('#818cf8'), p(2), rounded('4px'), textColor('#ffffff'), text(xs)) }, 'w-1/2'),
          tailwindCode: 'w-1/2',
      ...
      examples: [
        {
          label: 'h-16 (4rem)',
          twcCode: 'cx(h(16))',
          twcElement: React.createElement('div', { className: cx(h(16), w(16), bg('#818cf8'), rounded('4px'), flex(), items('center'), justify('center'), textColor('#ffffff'), text(xs)) }, 'h-16'),
          tailwindCode: 'h-16',
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bg('#818cf8'), p(2), rounded('4px'), textColor('#ffffff'), text(xs), maxH('3rem'), overflow('hidden')) }, 'h-screen (100vh — capped for display)'),
      ...
      examples: [
        {
          ...
          twcCode: 'cx(size(12))',
          twcElement: React.createElement('div', { className: cx(size(12), bg('#818cf8'), rounded('4px'), flex(), items('center'), justify('center'), textColor('#ffffff'), text(xs)) }, '12'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(minW('8rem'), bg('#818cf8'), p(2), rounded('4px'), textColor('#ffffff'), text(xs), display('inline-block')) }, 'min-w'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(maxW('20rem'), bg('#818cf8'), p(2), rounded('4px'), textColor('#ffffff'), text(xs)) }, 'This text is constrained to max-w-xs (20rem) and will wrap when it exceeds that width.'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(minH('4rem'), w(24), bg('#818cf8'), p(2), rounded('4px'), flex(), items('center'), textColor('#ffffff'), text(xs)) }, 'min-h'),
        ...
        },
        {
          label: 'max-h-20 (5rem)',
          twcCode: 'cx(maxH(20))',
          twcElement: React.createElement('div', { className: cx(maxH(20), w(24), bg('#818cf8'), p(2), rounded('4px'), overflow('auto'), textColor('#ffffff'), text(xs)) }, 'Content that is taller than max-h-20 will scroll because of overflow auto applied to this container.'),
