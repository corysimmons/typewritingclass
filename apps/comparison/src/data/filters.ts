...
const sampleBoxClasses = cx(textColor('white'), text(xs), textAlign('center'), flex(), items('center'), justify('center'))
      ...
      examples: [
        {
          label: 'blur-none',
          twcCode: 'blur("none")',
          twcElement: React.createElement('div', { className: cx(blur("none"), bg('indigo-400'), p(4), rounded("lg"), w(32), h(12), sampleBoxClasses) }, 'blur-none'),
        ...
        },
        {
          label: 'blur-sm (4px)',
          twcCode: 'blur("sm")',
          twcElement: React.createElement('div', { className: cx(blur("sm"), bg('indigo-400'), p(4), rounded("lg"), w(32), h(12), sampleBoxClasses) }, 'blur-sm'),
        ...
        },
        {
          label: 'blur (8px)',
          twcCode: 'blur()',
          twcElement: React.createElement('div', { className: cx(blur(), bg('indigo-400'), p(4), rounded("lg"), w(32), h(12), sampleBoxClasses) }, 'blur'),
          tailwindCode: 'blur',
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(brightness('50%'), bg('indigo-400'), p(4), rounded("lg"), sampleBoxClasses) }, 'brightness-50'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(brightness('150%'), bg('indigo-400'), p(4), rounded("lg"), sampleBoxClasses) }, 'brightness-150'),
      ...
      examples: [
        {
          label: 'contrast-50',
          twcCode: 'contrast("50%")',
          twcElement: React.createElement('div', { className: cx(contrast('50%'), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'contrast-50'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(contrast('200%'), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'contrast-200'),
      ...
      examples: [
        {
          label: 'grayscale',
          twcCode: 'grayscale()',
          twcElement: React.createElement('div', { className: cx(grayscale(), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'grayscale'),
        ...
        },
        {
          label: 'sepia',
          twcCode: 'sepia()',
          twcElement: React.createElement('div', { className: cx(sepia(), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'sepia'),
          tailwindCode: 'sepia',
      ...
      examples: [
        {
          label: 'invert',
          twcCode: 'invert()',
          twcElement: React.createElement('div', { className: cx(invert(), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'invert'),
          tailwindCode: 'invert',
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(saturate('200%'), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'saturate-200'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(hueRotate('90deg'), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'hue-rotate-90'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(hueRotate('180deg'), bg('indigo-400'), p(4), rounded("lg"), textColor('white'), text(xs)) }, 'hue-rotate-180'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(relative(), w(48), h(20), bgImage('linear-gradient(135deg, #818cf8, #f43f5e)'), rounded("lg"), overflow('hidden')) },
            React.createElement('div', { className: cx(backdropBlur("md"), absolute(), inset(4), rounded(), flex(), items('center'), justify('center'), bg('rgba(255,255,255,0.2)'), textColor('white'), text(xs)) }, 'backdrop-blur'),
          ),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(relative(), w(48), h(20), bgImage('linear-gradient(135deg, #818cf8, #f43f5e)'), rounded("lg"), overflow('hidden')) },
            React.createElement('div', { className: cx(backdropGrayscale(), absolute(), inset(4), rounded(), flex(), items('center'), justify('center'), bg('rgba(255,255,255,0.1)'), textColor('white'), text(xs)) }, 'backdrop-grayscale'),
          ),
