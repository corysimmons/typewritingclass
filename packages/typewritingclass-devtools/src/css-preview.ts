...
// ---------------------------------------------------------------------------
// Color scales (mirrors packages/typewritingclass/src/theme/colors.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Typography presets (mirrors packages/typewritingclass/src/theme/typography.ts)
// ---------------------------------------------------------------------------
...
const textSizes: Record<string, TextSize> = {
 ...
 */
function resolveSpacingArg(raw: string): string | undefined {
  const stripped = stripQuotes(raw.trim());
...
// ---------------------------------------------------------------------------
// CSS declaration generators — one per utility function
// ---------------------------------------------------------------------------

type CSSDeclarations = Record<string, string>;

interface UtilityGenerator {
  (arg: string): CSSDeclarations | undefined;
}

// Spacing utilities  --  map a spacing argument to one or more CSS properties
function spacingUtil(props: string[]): UtilityGenerator {
  return (arg: string) => {
...
function colorUtil(prop: string): UtilityGenerator {
  return (arg: string) => {
...
function passthrough(prop: string): UtilityGenerator {
  return (arg: string) => {
...
const utilityRegistry: Record<string, UtilityGenerator> = {
  // Spacing — padding
  ...
  grid: (arg: string) => {
    const stripped = stripQuotes(arg.trim());
    const decls: CSSDeclarations = { display: 'grid' };
    if (stripped) {
      const num = Number(stripped);
      if (!isNaN(num)) {
...
function formatDeclarations(decls: CSSDeclarations, indent: string = ''): string {
 ...
 */
export function generateWhenPreview(modifierArgs: string, utilityArgs: string): string | undefined {
 ...
 */
export function parseFunctionCalls(input: string): Array<{ name: string; args: string }> {
 ...
 */
export function getKnownUtilities(): string[] {
 ...
 */
export function getKnownModifiers(): string[] {
