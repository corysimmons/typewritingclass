      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(flex(), gap(2), items('center')) },
            React.createElement('div', { className: cx(bg('indigo-400'), p(2), rounded(), textColor('white'), text(xs)) }, 'Visible'),
            React.createElement('span', { className: cx(srOnly()) }, 'Screen reader only text'),
            React.createElement('span', { className: cx(text(xs), textColor('slate-500')) }, '(hidden span with sr-only is here)'),
          ),
        ...
        },
        {
          label: 'not-sr-only',
          twcCode: 'notSrOnly()',
          twcElement: React.createElement('div', { className: cx(notSrOnly(), bg('indigo-200'), p(4), rounded(), text(xs)) }, 'This reverses sr-only (not-sr-only)'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(forcedColorAdjust('auto'), bg('indigo-400'), p(4), rounded(), textColor('white'), text(xs)) }, 'forced-color-adjust: auto'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(forcedColorAdjust('none'), bg('indigo-400'), p(4), rounded(), textColor('white'), text(xs)) }, 'forced-color-adjust: none'),
