...
import {
  cx, bg, bgClip, bgPosition, bgRepeat, bgSize, bgImage,
  bgGradient, gradientFrom, gradientVia, gradientTo,
  p, w, h, rounded, textColor, text, font, border, borderColor,
      ...
      examples: [
        {
          label: 'bg-blue-500',
          twcCode: 'bg("blue-500")',
          twcElement: React.createElement('div', { className: cx(bg('blue-500'), p(4), rounded(), textColor('white')) }, 'bg-blue-500'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bg('emerald-400'), p(4), rounded(), textColor('white')) }, 'bg-emerald-400'),
        ...
        },
        {
          label: 'bg-rose-500',
          twcCode: 'bg("rose-500")',
          twcElement: React.createElement('div', { className: cx(bg('rose-500'), p(4), rounded(), textColor('white')) }, 'bg-rose-500'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bg('amber-300'), p(4), rounded()) }, 'bg-amber-300'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgGradient('to right'), gradientFrom('blue-500'), gradientTo('violet-500'), p(4), rounded(), textColor('white')) }, 'to right'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgGradient('to bottom right'), gradientFrom('rose-500'), gradientVia('amber-500'), gradientTo('emerald-500'), p(4), rounded(), textColor('white')) }, 'to bottom right'),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgGradient('to top'), gradientFrom('emerald-500'), gradientTo('cyan-500'), p(4), rounded(), textColor('white')) }, 'to top'),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgPosition('center'), bgRepeat('no-repeat'), w(32), h(16), rounded(), border(), borderColor('indigo-200'), bgImage(squareSvg)) }),
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgSize('contain'), bgRepeat('no-repeat'), bgPosition('center'), w(32), h(16), rounded(), border(), borderColor('indigo-200'), bgImage(circleSvg)) }),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgRepeat('repeat'), w(40), h(16), rounded(), border(), borderColor('indigo-200'), bgImage(checkerSvg)) }),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: cx(bgRepeat('no-repeat'), w(40), h(16), rounded(), border(), borderColor('indigo-200'), bgImage(dotSvg)) }),
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('span', { className: cx(bgClip('text'), text(_2xl), font(bold), bgGradient('to right'), gradientFrom('blue-500'), gradientTo('violet-500'), textColor('transparent')) }, 'Gradient Text'),
