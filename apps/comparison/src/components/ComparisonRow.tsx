  ...
  return (
    <div data-comparison-row={example.label} className={tw
      ...
      <div className={tw.px(4).py(2).bg('#f8fafc').borderB('1px').borderColor('#e2e8f0')}>
        <span className={tw.text('sm').font('600').textColor('#334155')}>{example.label}</span>
      </div>
      <div className={tw.grid.gridCols(2).minH(0)}>
        {/* TWC Column */}
        <div className={tw.p(4).flex.flexCol.gap(3).borderR('1px').borderColor('#e2e8f0')}>
          <div className={tw.text('xs').font('500').textColor('#6366f1').textTransform('uppercase').tracking('0.05em')}>
            typewritingclass
          </div>
        ...
        <div className={tw.p(4).flex.flexCol.gap(3)}>
          <div className={tw.text('xs').font('500').textColor('#0ea5e9').textTransform('uppercase').tracking('0.05em')}>
            Tailwind CSS
          </div>
