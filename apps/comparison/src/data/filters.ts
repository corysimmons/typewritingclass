...
const sampleBox = (label: string) => ({
  style: { color: 'white', fontSize: '12px', textAlign: 'center' as const, display: 'flex', alignItems: 'center', justifyContent: 'center' },
})
  ...
  sections: [
      ...
      examples: [
        {
          label: 'blur-none',
          twcCode: 'cx(blur("0"))',
          twcElement: React.createElement('div', { className: cx(blur('0'), bg('#818cf8'), p(4), rounded('0.5rem'), w('8rem'), h('3rem')), ...sampleBox('') }, 'blur-none'),
        ...
        },
        {
          label: 'blur-sm (4px)',
          twcCode: 'cx(blur("4px"))',
          twcElement: React.createElement('div', { className: cx(blur('4px'), bg('#818cf8'), p(4), rounded('0.5rem'), w('8rem'), h('3rem')), ...sampleBox('') }, 'blur-sm'),
        ...
        },
        {
          label: 'blur (8px)',
          twcCode: 'cx(blur("8px"))',
          twcElement: React.createElement('div', { className: cx(blur('8px'), bg('#818cf8'), p(4), rounded('0.5rem'), w('8rem'), h('3rem')), ...sampleBox('') }, 'blur'),
          tailwindCode: 'blur',
    ...
    },
    {
      ...
      examples: [
        {
          label: 'brightness-50',
          twcCode: 'cx(brightness("50%"))',
          twcElement: React.createElement('div', { className: cx(brightness('50%'), bg('#818cf8'), p(4), rounded('0.5rem')), ...sampleBox('') }, 'brightness-50'),
        ...
        },
        {
          ...
          twcCode: 'cx(brightness("150%"))',
          twcElement: React.createElement('div', { className: cx(brightness('150%'), bg('#818cf8'), p(4), rounded('0.5rem')), ...sampleBox('') }, 'brightness-150'),
    ...
    },
    {
      ...
      examples: [
        {
          label: 'contrast-50',
          twcCode: 'cx(contrast("50%"))',
          twcElement: React.createElement('div', { className: cx(contrast('50%'), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff')), style: { fontSize: '12px' } }, 'contrast-50'),
        ...
        {
          label: 'contrast-200',
          twcCode: 'cx(contrast("200%"))',
          twcElement: React.createElement('div', { className: cx(contrast('200%'), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff')), style: { fontSize: '12px' } }, 'contrast-200'),
    ...
    },
    {
      ...
      examples: [
        {
          label: 'grayscale',
          twcCode: 'cx(grayscale("100%"))',
          twcElement: React.createElement('div', { className: cx(grayscale('100%'), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff')), style: { fontSize: '12px' } }, 'grayscale'),
        ...
        {
          label: 'sepia',
          twcCode: 'cx(sepia("100%"))',
          twcElement: React.createElement('div', { className: cx(sepia('100%'), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff')), style: { fontSize: '12px' } }, 'sepia'),
          tailwindCode: 'sepia',
    ...
    },
    {
      ...
      examples: [
        {
          label: 'invert',
          twcCode: 'cx(invert("100%"))',
          twcElement: React.createElement('div', { className: cx(invert('100%'), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff')), style: { fontSize: '12px' } }, 'invert'),
          tailwindCode: 'invert',
        ...
        {
          label: 'saturate-200',
          twcCode: 'cx(saturate("200%"))',
          twcElement: React.createElement('div', { className: cx(saturate('200%'), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff')), style: { fontSize: '12px' } }, 'saturate-200'),
    ...
    },
    {
      ...
      examples: [
        {
          label: 'hue-rotate-90',
          twcCode: 'cx(hueRotate("90deg"))',
          twcElement: React.createElement('div', { className: cx(hueRotate('90deg'), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff')), style: { fontSize: '12px' } }, 'hue-rotate-90'),
        ...
        },
        {
          ...
          twcCode: 'cx(hueRotate("180deg"))',
          twcElement: React.createElement('div', { className: cx(hueRotate('180deg'), bg('#818cf8'), p(4), rounded('0.5rem'), textColor('#ffffff')), style: { fontSize: '12px' } }, 'hue-rotate-180'),
      ...
      examples: [
        {
          ...
          twcCode: 'cx(backdropBlur("12px"))',
          twcElement: React.createElement('div', { style: { position: 'relative', width: '12rem', height: '5rem', background: 'linear-gradient(135deg, #818cf8, #f43f5e)', borderRadius: '0.5rem', overflow: 'hidden' } },
            React.createElement('div', { className: cx(backdropBlur('12px'), css({ position: 'absolute', inset: '1rem', 'border-radius': '0.25rem', display: 'flex', 'align-items': 'center', 'justify-content': 'center' })), style: { background: 'rgba(255,255,255,0.2)', color: 'white', fontSize: '12px' } }, 'backdrop-blur'),
          ),
        ...
        },
        {
          ...
          twcCode: 'cx(backdropGrayscale("100%"))',
          twcElement: React.createElement('div', { style: { position: 'relative', width: '12rem', height: '5rem', background: 'linear-gradient(135deg, #818cf8, #f43f5e)', borderRadius: '0.5rem', overflow: 'hidden' } },
            React.createElement('div', { className: cx(backdropGrayscale('100%'), css({ position: 'absolute', inset: '1rem', 'border-radius': '0.25rem', display: 'flex', 'align-items': 'center', 'justify-content': 'center' })), style: { background: 'rgba(255,255,255,0.1)', color: 'white', fontSize: '12px' } }, 'backdrop-grayscale'),
          ),
