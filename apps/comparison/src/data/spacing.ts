      ...
      examples: [
        {
          ...
          twcCode: 'p(4)',
          twcElement: React.createElement('div', { className: `${tw.p(4).bg('indigo-200')}` }, 'p-4'),
          tailwindCode: 'p-4',
        ...
        },
        {
          ...
          twcCode: 'px(6)',
          twcElement: React.createElement('div', { className: `${tw.px(6).bg('indigo-200')}` }, 'px-6'),
          tailwindCode: 'px-6',
        ...
        },
        {
          ...
          twcCode: 'py(3)',
          twcElement: React.createElement('div', { className: `${tw.py(3).bg('indigo-200')}` }, 'py-3'),
          tailwindCode: 'py-3',
        ...
        },
        {
          label: 'pt-8 (2rem top)',
          twcCode: 'pt(8)',
          twcElement: React.createElement('div', { className: `${tw.pt(8).bg('indigo-200')}` }, 'pt-8'),
          tailwindCode: 'pt-8',
        ...
        },
        {
          ...
          twcCode: 'pr(2)',
          twcElement: React.createElement('div', { className: `${tw.pr(2).bg('indigo-200')}` }, 'pr-2'),
          tailwindCode: 'pr-2',
        ...
        },
        {
          ...
          twcCode: 'pb(5)',
          twcElement: React.createElement('div', { className: `${tw.pb(5).bg('indigo-200')}` }, 'pb-5'),
          tailwindCode: 'pb-5',
        ...
        },
        {
          ...
          twcCode: 'pl(10)',
          twcElement: React.createElement('div', { className: `${tw.pl(10).bg('indigo-200')}` }, 'pl-10'),
          tailwindCode: 'pl-10',
      ...
      examples: [
        {
          ...
          twcCode: 'm(4)',
          twcElement: React.createElement('div', { className: `${tw.bg('indigo-100')}` },
            React.createElement('div', { className: `${tw.m(4).bg('indigo-400').textColor('white').p(1)}` }, 'm-4')
          ),
          tailwindCode: 'm-4',
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: `${tw.bg('indigo-100')}` },
            React.createElement('div', { className: `${tw.mx('auto').w(32).bg('indigo-400').textColor('white').p(1).textAlign('center')}` }, 'mx-auto')
          ),
        ...
        },
        {
          ...
          twcCode: 'my(6)',
          twcElement: React.createElement('div', { className: `${tw.bg('indigo-100')}` },
            React.createElement('div', { className: `${tw.my(6).bg('indigo-400').textColor('white').p(1)}` }, 'my-6')
          ),
          tailwindCode: 'my-6',
          tailwindElement: React.createElement('div', { className: 'tw-bg-indigo-100' },
      ...
      examples: [
        {
          ...
          twcElement: React.createElement('div', { className: `${tw.flex.spaceX(4)}` },
            React.createElement('div', { className: `${tw.p(2).bg('indigo-400').textColor('white')}` }, '1'),
            React.createElement('div', { className: `${tw.p(2).bg('indigo-400').textColor('white')}` }, '2'),
            React.createElement('div', { className: `${tw.p(2).bg('indigo-400').textColor('white')}` }, '3'),
          ),
        ...
        },
        {
          ...
          twcElement: React.createElement('div', { className: `${tw.flex.flexCol.spaceY(3)}` },
            React.createElement('div', { className: `${tw.p(2).bg('indigo-400').textColor('white')}` }, 'A'),
            React.createElement('div', { className: `${tw.p(2).bg('indigo-400').textColor('white')}` }, 'B'),
            React.createElement('div', { className: `${tw.p(2).bg('indigo-400').textColor('white')}` }, 'C'),
          ),
